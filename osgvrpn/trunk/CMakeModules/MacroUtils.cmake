...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(PRESENT3D_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${PRESENT3D_VERSION} SOVERSION ${PRESENT3D_SOVERSION})
    ENDIF(PRESENT3D_SONAMES)
...
MACRO(SETUP_EXE IS_COMMANDLINE_APP)
    ...
    ELSE(${IS_COMMANDLINE_APP})
        ...
        IF(APPLE)
            # SET(MACOSX_BUNDLE_LONG_VERSION_STRING "${PRESENT3D_MAJOR_VERSION}.${PRESENT3D_MINOR_VERSION}.${PRESENT3D_PATCH_VERSION}")
            # Short Version is the "marketing version". It is the version
            # the user sees in an information panel.
            SET(MACOSX_BUNDLE_SHORT_VERSION_STRING "${PRESENT3D_MAJOR_VERSION}.${PRESENT3D_MINOR_VERSION}.${PRESENT3D_PATCH_VERSION}")
            # Bundle version is the version the OS looks at.
            SET(MACOSX_BUNDLE_BUNDLE_VERSION "${PRESENT3D_MAJOR_VERSION}.${PRESENT3D_MINOR_VERSION}.${PRESENT3D_PATCH_VERSION}")
        ...
        IF(APPLE)
            IF(P3D_BUILD_APPLICATION_BUNDLES)
                SET(PLATFORM_SPECIFIC_CONTROL MACOSX_BUNDLE)
            ENDIF(P3D_BUILD_APPLICATION_BUNDLES)
        ENDIF(APPLE)
