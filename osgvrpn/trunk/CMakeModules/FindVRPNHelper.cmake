...
# Macro to force the stock FindOpenSceneGraph.cmake script to search again for OSG.
macro( unFindOSG )
#    message( STATUS "In unFindOSG" )

    foreach( currentLibIn ${_vrpnComponents} )
...
find_package( OpenSceneGraph 2.8.0 REQUIRED COMPONENTS ${_vrpnComponents} )
if( OSG_FOUND )
    foreach( currentLibIn ${_vrpnComponents} )
        string( TOUPPER ${currentLibIn} currentLib )
