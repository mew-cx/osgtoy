...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../../include" /I "INSTALLDIR/include" /I "ROOTDIR/3rdParty/include" /D "NDEBUG" /D "_MBCS" /D "_USRDLL" /D "OSGVRPN_LIBRARY" /D "WIN32" /D "_WINDOWS" /D "_CRT_SECURE_NO_DEPRECATE" /YX /FD /Zm200 /c
...
# ADD LINK32 OpenThreads.lib vrpn.lib opengl32.lib glu32.lib wsock32.lib /nologo /dll /debug /machine:I386 /out:"$(OutDir)/osgVRPN.dll" /implib:"../../lib/osgVRPN.lib" /libpath:"../../lib" /libpath:"$(INSTALLDIR)/lib" /libpath:"$(ROOTDIR)/3rdParty/lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /vmg /GR /GX /Zi /Od /I "../../include" /I "INSTALLDIR/include" /I "ROOTDIR/3rdParty/include" /D "OSGVRPN_LIBRARY" /D "_WINDOWS" /D "WIN32" /D "_DEBUG" /D "_CRT_SECURE_NO_DEPRECATE" /YX /FD /GZ /Zm200 /c
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsd.lib vrpnD.lib opengl32.lib glu32.lib wsock32.lib /nologo /dll /debug /machine:I386 /out:"$(OutDir)/osgVRPND.dll" /pdbtype:sept /implib:"../../lib/osgVRPND.lib" /libpath:"../../lib" /libpath:"$(INSTALLDIR)/lib" /libpath:"$(ROOTDIR)/3rdParty/lib"
...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "../../include" /I "INSTALL/include" /I "ROOTDIR/3rdParty/include" /D "NDEBUG" /D "_MBCS" /D "OSG_LIBRARY_STATIC" /D "OT_LIBRARY_STATIC" /D "PR_LIBRARY_STATIC" /D "WIN32" /D "_WINDOWS" /D "_CRT_SECURE_NO_DEPRECATE" /YX /FD /Zm200 /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x809 /d "NDEBUG"
# ADD RSC /l 0x809 /d "NDEBUG"
...
# ADD CPP /nologo /MTd /W3 /Gm /vmg /GR /GX /Z7 /Od /I "../../include" /I "INSTALLDIR/include" /I "ROOTDIR/3rdParty/include" /D "OSG_LIBRARY_STATIC" /D "OT_LIBRARY_STATIC" /D "PR_LIBRARY_STATIC" /D "_WINDOWS" /D "WIN32" /D "_DEBUG" /D "_CRT_SECURE_NO_DEPRECATE" /YX /FD /GZ /Zm200 /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x809 /d "_DEBUG"
# ADD RSC /l 0x809 /d "_DEBUG"
