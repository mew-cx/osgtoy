...
; for VirtualPlanetBuilder x.x http://openscenegraph.org/
; by Mike Weiblen http://mew.cx/

[Setup]
AppName=VirtualPlanetBuilder
AppVerName=VirtualPlanetBuilder 0.9.5 BETA TEST vs8.0sp1 2008-01-29
OutputBaseFilename=osg0.9.5_vs80sp1_setup_2008-01-29
VersionInfoTextVersion=0.9.5-r876_vs80sp1
VersionInfoVersion=0.9.5.876
AppPublisher=http://mew.cx/
AppPublisherURL=http://mew.cx/osg/
DefaultDirName={pf}\VirtualPlanetBuilder
DefaultGroupName=VirtualPlanetBuilder
AllowNoIcons=yes
...
SetupIconFile=VirtualPlanetBuilder\VisualStudio\icons\osg.ico
...
Name: "{group}\Uninstall VirtualPlanetBuilder 0.9.5 BETA TEST vs8.0sp1 2008-01-29" ; Filename: "{uninstallexe}"
