...
AppVerName=OpenSceneGraph 2.3-r8012 BETA TEST vs8.0sp1 2008-03-31
OutputBaseFilename=osg2.3-r8012_vs80sp1_setup_2008-03-31
VersionInfoTextVersion=2.3-r8012_vs80sp1
VersionInfoVersion=2.3.0.8012
...
Source: "_BUILD\bin\*"; DestDir: "{app}\bin"; Flags: ignoreversion recursesubdirs
...
Source: "_BUILD\lib\*"; Excludes: ".svn"; DestDir: "{app}\lib"; Flags: ignoreversion recursesubdirs
...
Name: "{group}\Uninstall OpenSceneGraph 2.3-r8012 BETA TEST vs8.0sp1 2008-03-31" ; Filename: "{uninstallexe}"
