# Microsoft Developer Studio Project File - Name="osgPlugin drawnorm" - Package Owner=<4>
...
CFG=osgPlugin drawnorm - Win32 Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "drawnorm.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "drawnorm.mak" CFG="osgPlugin drawnorm - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "osgPlugin drawnorm - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "osgPlugin drawnorm - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "osgPlugin drawnorm - Win32 Release Static" (based on "Win32 (x86) Static Library")
!MESSAGE "osgPlugin drawnorm - Win32 Debug Static" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
!IF  "$(CFG)" == "osgPlugin drawnorm - Win32 Release"
...
# ADD LINK32 OpenThreadsWin32.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_drawnorm.dll" /implib:"../../../lib/$(PlatformName)/osgdb_drawnorm.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../Producer/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin drawnorm - Win32 Debug"
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsWin32d.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_drawnormD.dll" /pdbtype:sept /implib:"../../../lib/$(PlatformName)/osgdb_drawnormD.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../Producer/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin drawnorm - Win32 Release Static"
...
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_drawnorm_s.lib"
# SUBTRACT LIB32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin drawnorm - Win32 Debug Static"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_drawnormD_s.lib"
# SUBTRACT LIB32 /nodefaultlib
...
# Name "osgPlugin drawnorm - Win32 Release"
# Name "osgPlugin drawnorm - Win32 Debug"
# Name "osgPlugin drawnorm - Win32 Release Static"
# Name "osgPlugin drawnorm - Win32 Debug Static"
# Begin Group "Source Files"

# PROP Default_Filter "cpp;c;cxx;rc;def;r;odl;idl;hpj;bat"
# Begin Source File

SOURCE=..\..\..\src\osgPlugins\drawnorm\ReaderWriterDRAWNORM.cpp
# End Source File
# End Group
