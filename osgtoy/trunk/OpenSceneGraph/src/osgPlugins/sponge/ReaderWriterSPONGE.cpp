 ...
 * $Id: ReaderWriterSPONGE.cpp,v 1.1 2005/06/06 22:10:37 mew Exp $
*/
...
public:
    ReaderWriterSPONGE() {}
    virtual ~ReaderWriterSPONGE() {}
    
    virtual const char* className() const { return "Menger sponge pseudo-loader"; }
