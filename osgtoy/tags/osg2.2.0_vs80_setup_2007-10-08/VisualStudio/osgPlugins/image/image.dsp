# Microsoft Developer Studio Project File - Name="osgPlugin image" - Package Owner=<4>
...
CFG=osgPlugin image - Win32 Release
...
!MESSAGE 
!MESSAGE NMAKE /f "image.mak" CFG="osgPlugin image - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "osgPlugin image - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "osgPlugin image - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "osgPlugin image - Win32 Release Static" (based on "Win32 (x86) Static Library")
!MESSAGE "osgPlugin image - Win32 Debug Static" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
!IF  "$(CFG)" == "osgPlugin image - Win32 Release"
...
# ADD LINK32 OpenThreadsWin32.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_image.dll" /implib:"../../../lib/$(PlatformName)/osgdb_image.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../Producer/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin image - Win32 Debug"
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsWin32d.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_imageD.dll" /pdbtype:sept /implib:"../../../lib/$(PlatformName)/osgdb_imageD.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../Producer/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin image - Win32 Release Static"
...
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_image_s.lib"
# SUBTRACT LIB32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin image - Win32 Debug Static"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_imageD_s.lib"
# SUBTRACT LIB32 /nodefaultlib
...
# Name "osgPlugin image - Win32 Release"
# Name "osgPlugin image - Win32 Debug"
# Name "osgPlugin image - Win32 Release Static"
# Name "osgPlugin image - Win32 Debug Static"
# Begin Group "Source Files"

# PROP Default_Filter "cpp;c;cxx;rc;def;r;odl;idl;hpj;bat"
# Begin Source File

SOURCE=..\..\..\src\osgPlugins\image\ReaderWriterIMAGE.cpp
# End Source File
# End Group
